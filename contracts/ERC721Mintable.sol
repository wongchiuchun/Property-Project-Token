...
contract Pausable is Ownable {
    ...
    function changestatus(bool newStatus) onlyOwner() public returns (bool) {
...
contract ERC721 is Pausable, ERC165 {
    ...
    //address private _owner = getowner();
...
//    @dev Approves another address to transfer the given token ID
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        require(_exists(tokenId));// TODO return token approval if it exists
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    constructor (string memory name, string memory symbol) public {
        ...
        _name = name;
        _symbol = symbol;
        //_baseTokenURI = baseTokenURI;, string memory baseTokenURI
